  ...
  return (
    ...
    >
      ...
      <div style={{ margin: "10px" }}>
        <h1 class="title">Habla con nosotras</h1>
      ...
      <div class="col-sm-4" style={{ margin: "10px" }}>
        <div class="con_info_wrap">
          <h4 class="info_title">Información Contacto</h4>
          <ul class="con_info_menu">
            <li>
              <span class="con_info_text">
                {" "}
                <FiMail></FiMail> patriciaexposito.psicologa@gmail.com
              </span>
            </li>
            <li>
              <span class="con_info_text">
          ...
          <h5 class="followTitle">¡¡Sígueme!!</h5>
          <ul class="followLink">
            <li>
