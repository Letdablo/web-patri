import "./style.scss";
import { FiPhoneCall, FiMail, FiLinkedin, FiInstagram } from "react-icons/fi";
...
function Footer() {
  ...
  async function sendEmail() {
    if (nombre === "" || mail === "" || phone === "") {
      alert("Rellana los datos de contacto");
      return;
    }
    alert("Se han enviado tus datos correctamente :)");
    setMailSend(true);
    window.Email.send({
      Host: "smtp.gmail.com",
      Username: "patriciaexposito.psicologa@gmail.com",
      Password: "ygnzrshuiyjdgfyf",
      To: "patriciaexposito.psicologa@gmail.com",
      From: "patriciaexposito.psicologa@gmail.com",
      Subject: "Nuevo pacientito",
      Body: `<span> nombre: </span> <span> ${nombre} </span><br/>
        <span> mail: </span> <span> ${mail} </span><br/><br/>
        <span> phone: </span> <span> ${phone} </span><br/><br/>
  ...
  return (
    <div
      id="contacta"
      class="footer containerContact d-flex justify-content-center align-items-center"
    >
      {/*   <svg
        class="svg"
      ...
      <div style={{ width: "80%", minWidth: 360, padding: 10 }}>
        <iframe
          ...
          width="100%"
          height="500"
          src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=es&amp;q=avenida%20de%20am%C3%A9rica%208,%20madrid,%20bajo%20D+(Tu%20ra%C3%ADz%20psicolog%C3%ADa)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
      </div>
      ...
      <div style={{ margin: "10px", width: "55%", minWidth: 360 }}>
        ...
        <div class="form-group position-relative">
          <label for="formTel" class="d-block">
        ...
        <div class="form-group message">
          <textarea
            id="formMessage"
            class="form-control form-control-lg thickTa"
            rows="7"
            placeholder="Mensaje"
        ...
        >
          {!mailSend && (
            <div class="box-3">
              <div class="btn btn-three" onClick={() => sendEmail()}>
                <span class="text-btn">CONTACTA YA</span>
              </div>
            </div>
          )}
        </div>{" "}
      ...
      >
        <div class="con_info_wrap">
          ...
          <ul class="con_info_menu">
            <li>
              <span class="con_info_text">
                {" "}
                <FiMail></FiMail> info@turaizpsicologia.com
              </span>
            </li>
            <li>
              <span class="con_info_text">
                <FiPhoneCall /> 626419873
              </span>
            </li>
          </ul>

          <h5 class="followTitle">Síguenos</h5>
          <ul class="followLink">
            <li>
              <i class="fa fa-linkedin">
                <a href="https://www.linkedin.com/in/patricia-expósito-rubio-442285171">
                  <FiLinkedin size="30" color="0000" />
                </a>
              </i>
            </li>
            <li>
              <i class="fa fa-pinterest-p">
                {" "}
                <a href="https://www.instagram.com/patriciaexpositopsicologa/">
                  <FiInstagram size="30" color="0000" />
                </a>
              </i>
            </li>
          </ul>
